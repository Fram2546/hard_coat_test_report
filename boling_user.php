...
<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $conn->prepare("UPDATE tracking SET BatchGenQC = :BatchGenQC, roundboling = :roundboling, 
...
<body>
    <div class="container mt-5">
        ...
        <hr>
            <form action="boling_user.php" method="post" enctype="multipart/form-data">
            <?php
            if (isset($_GET['id'])) {
                $id = $_GET['id'];
