    ...
    <nav id="sidebarMenu" class="col-md-3 col-lg-2 d-md-block bg-light sidebar collapse">
      <div class="position-sticky pt-3">
        <ul class="nav flex-column">
          <li class="nav-item">
          <a class="btn btn-toggle align-items-center rounded collapsed" aria-current="page" href="admin.php"><span data-feather="home"></span> Home </a> </li>
          <li class="nav-item"><a class="nav-link" href="data.php"> <span data-feather="plus-circle" class="align-text-bottom"></span> Data </a></li>
          <li class="nav-item"><a class="nav-link" href="option.php"> <span data-feather="file" class="align-text-bottom"></span> Option Detail  </a></li>
          <li class="nav-item"><a class="nav-link" href="option_Level.php"> <span data-feather="file" class="align-text-bottom"></span> Option Detail Level </a></li>
      </div> 
