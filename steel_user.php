...
<?php 
    ...
    if (isset($_POST['submit'])) {
        ...
        $stmt = $conn->prepare("UPDATE tracking SET  BatchGenQC = :BatchGenQC, roundsteel = :roundsteel, steel = :steel, resultsteel = :resultsteel, testersteel = :testersteel WHERE id = :id ");
...
<body>
    <div class="container mt-5">
        ...
        <hr>
            <form action="steel_user.php" method="post" enctype="multipart/form-data">
            <?php
              if (isset($_GET['id'])) {
                $id = $_GET['id'];
