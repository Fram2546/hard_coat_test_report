...
<main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
      ...
      <div class="row">
        ...
        <table class="table" align="center">
            <thead>
                ...
                <th scope="col" style="width: 5%;">abruptly_cc1</th>
           
                <th scope="col" style="width: 5%;">break_cc1</th>
          
                <th scope="col" style="width: 5%;">peeling_cc1</th>
              
                <th scope="col" style="width: 5%;">tape_cc1</th>
           
                <th scope="col" style="width: 5%;">abruptly_cx1</th>

                <th scope="col" style="width: 5%;">break_cx1</th>
  ...
  <ul class="pagination justify-content-end">
    <li class="page-item"><a class="page-link" href="data_boling2.php">CYCLE 2 </a></li>
  </ul>
</nav>
